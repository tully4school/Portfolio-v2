	...
	render() {
		return (
			<>
				...
				<div className='proficiencies p-5'>
					<div className='row'>
						<div className='col-12 col-lg-8 offset-lg-2 p-md-5'>
							<div className='row px-md-5'>
								<div className='col-6 mb-3 mb-sm-1 col-sm-3 px-xl-5'>
									<img src={HTML5} alt='HTML5 logo' className='img-fluid' />
								</div>
								<div className='col-6 mb-3 mb-sm-1 col-sm-3 px-xl-5'>
									<img src={CSS3} alt='HTML5 logo' className='img-fluid' />
								</div>
								<div className='col-6 mb-sm-1 col-sm-3 px-xl-5'>
								...
								<div className='row'>
									<div className='col-4 mt-5 col-sm-2'>
										<img
											src={Bootstrap}
											alt='HTML5 logo'
											className='img-fluid'
