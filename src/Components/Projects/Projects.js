					...
					<div className='row'>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classEleven='col-2 col-sm-2 mt-5 d-none'
								classTwelve='col-2 col-sm-2 mt-5 d-none'
								classThirteen='col-2 col-sm-2 d-flex align-items-center'
							/>
						</div>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								dialogClassName='modal-50w'
								img={<iframe src='https://silly-hermann-1f0614.netlify.com/' title='Cocktail Creator' />}
								src={Cocktails}
								...
								classOne='col-2 col-sm-2 px-md-4'
								classTwo='col-2 col-sm-2 px-md-4'
								classThree='col-2 col-sm-2 px-md-4'
								classFour='col-2 col-sm-2  px-md-4'
								classFive='col-2 col-sm-2 pt-5 d-none'
								classSix='col-2 col-sm-2 d-flex align-items-center'
								classSeven='col-2 col-sm-2 d-flex align-items-center'
						...
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classSeven='col-2 col-sm-2 d-flex align-items-center'
								classEight='col-2 col-sm-2 d-none'
								classNine='col-2 col-sm-2 d-flex align-items-center'
								classTen='col-2 col-sm-2 pt-5 d-none'
								classEleven='col-2 col-sm-2 pt-5 d-none'
								classTwelve='col-2 col-sm-2 d-flex align-items-center'
								classThirteen='col-2 col-sm-2 pt-5 d-none'
							/>
						</div>
					</div>
