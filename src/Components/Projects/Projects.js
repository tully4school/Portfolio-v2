					...
					<div className='row'>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5 justify-space-around'>
							<Modal
								...
								classOne='col-3 col-sm-4'
								classTwo='col-3 col-sm-4'
						...
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classOne='col-3 col-sm-4'
								classTwo='col-3 col-sm-4'
								classThree='col-3 col-sm-4'
								classFour='col-3 col-sm-4 d-none'
								classFive='col-3 col-sm-4 d-none'
								classSix='col-3 col-sm-4 d-none'
								classSeven='col-3 col-sm-4 d-flex align-items-center'
								classEight='col-3 col-sm-4 d-none'
								classNine='col-3 col-sm-4 d-none'
								classTen='col-3 col-sm-4 d-none'
								classEleven='col-3 col-sm-4 d-none'
						...
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classOne='col-3 col-sm-4 mt-5'
								classTwo='col-3 col-sm-4 mt-5'
								classThree='col-3 col-sm-4 mt-5'
								classFour='col-3 col-sm-4 mt-5 d-none'
								classFive='col-3 col-sm-4 mt-5 d-none'
								classSix='col-3 col-sm-4 mt-5 d-none'
								classSeven='col-3 col-sm-4 mt-5 d-flex align-items-center'
								classEight='col-3 col-sm-4 mt-5 d-none'
								classNine='col-3 col-sm-4 mt-5 d-none'
								classTen='col-3 col-sm-4 mt-5 d-none'
								classEleven='col-3 col-sm-4 mt-5 d-none'
								classTwelve='col-3 col-sm-4 mt-5 d-none'
								classThirteen='col-3 col-sm-4 mt-5 d-none'
							/>
						</div>
					</div>
					<div className='row'>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classEleven='col-3 col-sm-4 mt-5 d-none'
								classTwelve='col-3 col-sm-4 mt-5 d-none'
								classThirteen='col-3 col-sm-4 mt-5 d-flex align-items-center'
							/>
						</div>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
								...
								classOne='col-3 col-sm-4 pt-5 px-md-4'
								classTwo='col-3 col-sm-4 pt-5 px-md-4'
								classThree='col-3 col-sm-4 pt-5 px-md-4'
								classFour='col-3 col-sm-4 pt-5  px-md-4'
								classFive='col-3 col-sm-4 pt-5 d-none'
								classSix='col-3 col-sm-4 pt-5  d-flex align-items-center'
								classSeven='col-3 col-sm-4 pt-5 d-flex align-items-center'
								classEight='col-3 col-sm-4 pt-5 d-none'
								classNine='col-3 col-sm-4 pt-5  d-flex align-items-center'
								classTen='col-3 col-sm-4 pt-5 d-none'
								classEleven='col-3 col-sm-4 pt-5 d-none'
								classTwelve='col-3 col-sm-4 pt-5  d-flex align-items-center'
								classThirteen='col-3 col-sm-4 pt-5 d-none'
							/>
						</div>
						<div className='col-md-4 my-3 px-lg-3 px-xl-5'>
							<Modal
